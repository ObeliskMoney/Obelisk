...
//! Output: packages/shared/test/vectors.json
...
fn main() {
    ...
    let policy: Policy = serde_json::from_str(include_str!("../../../docs/policy.example.json")).unwrap();
    ...
    let path = concat!(env!("CARGO_MANIFEST_DIR"), "/../../packages/shared/test/vectors.json");
