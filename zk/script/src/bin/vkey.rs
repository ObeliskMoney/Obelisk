...
mod tests {
    ...
    /// If this fails after an ELF rebuild, deploy a new factory and update contracts/deployments/robinhood.json.
    #[test]
    fn committed_elf_matches_mainnet_program_vkey() {
        let raw = include_str!("../../../../contracts/deployments/robinhood.json");
